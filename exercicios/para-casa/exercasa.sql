...
INSERT INTO estoque_filmes (filme_id, quantidade, status_id) VALUES (3, 15, 'Alugado');
...
-- 3 Atualizar o status de um filme para "Alugado" e diminuir a quantidade em estoque para o filme com ID 1
UPDATE estoque_filmes
SET quantidade = quantidade - 1, status_id = 'Alugado'
